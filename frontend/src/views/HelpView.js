  ...
  return (
    <div className="container view-enter">
      ...
      <div style={{marginTop: '30px'}}>
        ...
        <ul style={{lineHeight: '1.8', color: 'var(--text-body)', marginLeft: '20px'}}>
      ...
      <div style={{marginTop: '30px'}}>
        <h3 style={{marginBottom: '15px'}}>🎯 User Tips</h3>
        <ul style={{lineHeight: '1.8', color: 'var(--text-body)', marginLeft: '20px'}}>
      ...
      <div style={{marginTop: '30px'}}>
        <h3 style={{marginBottom: '15px'}}>🔍 Search & Filter</h3>
        <ul style={{lineHeight: '1.8', color: 'var(--text-body)', marginLeft: '20px'}}>
      ...
      <div style={{marginTop: '30px'}}>
        <h3 style={{marginBottom: '15px'}}>📊 Tracking Progress</h3>
        <ul style={{lineHeight: '1.8', color: 'var(--text-body)', marginLeft: '20px'}}>
      ...
      <div style={{marginTop: '30px'}}>
        <h3 style={{marginBottom: '15px'}}>👥 Join B612!</h3>
        <ul style={{lineHeight: '1.8', color: 'var(--text-body)', marginLeft: '20px'}}>
      ...
      <div style={{marginTop: '40px', padding: '20px', background: '#000', border: '3px solid #000', color: 'var(--color-primary)'}}>
        <h3 style={{marginBottom: '15px', fontSize: '18px', color: 'var(--color-primary)'}}>💬 Feedback & Feature Requests</h3>
        <p style={{lineHeight: '1.6', marginBottom: '15px', color: '#fff'}}>
          Have suggestions or found a bug?
        </p>
        <div style={{display: 'flex', flexDirection: 'column', gap: '10px', color: '#fff'}}>
          <div>
            <strong>📧 Email:</strong>{' '}
            <a href="mailto:araouf88@gmail.com" style={{color: 'var(--color-primary)', textDecoration: 'underline', fontWeight: '700'}}>
              araouf88@gmail.com
            </a>
          </div>
          <div>
