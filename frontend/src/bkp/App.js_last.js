        ...
        <div className="home-container">
          ...
          <div className="practice-modes">
            ...
            >
              <div className="practice-mode-icon">🎲</div>
              <div className="practice-mode-content">
                <h4>Random Mode - All Sets</h4>
                <p>Questions pulled at random from all sets</p>
              </div>
            </button>
      ...
      {view === 'upload' && (
        <div className="container">
          ...
          <p style={{color: '#666', marginBottom: '30px'}}>
            Upload TSV files to add new question sets. All users will be able to see and play your uploaded sets.
          </p>
          ...
          <div className="upload-section">
            ...
            <div style={{marginBottom: '15px'}}>
              ...
              <input
                type="text"
                placeholder="e.g., WQC 2024, Entertainment, Part 1"
                value={uploadTags}
        ...
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '10px'}}>
          ...
          {practiceMode === 'mixed' && (
            <div style={{
              ...
              <p style={{color: '#666', marginBottom: '15px'}}> Play questions from all sets combined</p>
